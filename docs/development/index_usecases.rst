...
If you have not read `DNA Documentation for all users <http://docs.mvsdna.info/en/latest>`_ (http://docs.mvsdna.info/en/latest), we recommend you to read through as your basic knowledge of DNA.
...
* `What is different DNA <http://docs.mvsdna.info/en/latest/technology/difference_bitshares.html>`_ (http://docs.mvsdna.info/en/latest)
