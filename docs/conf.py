...
latex_documents = [
    (
        "index",
        "BBF.tex",
        u"DNA developer Documentation",
        u"DNA-Core & contributors",
        "manual",
    ),
]
...
try:
    ...
    print("=" * 80)
    print(
        "Please install 'breathe' as described in README.md to also have API documentation available!"
    )
    print("=" * 80)
