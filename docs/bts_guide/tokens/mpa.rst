...
A *SmartCoin* (synonym for MPA) is a crypto-currency that *always* has 100% or more of its value backed by the DNA core currency (DNA), to which they can be converted at any time, as *collateral* in a CFD.
